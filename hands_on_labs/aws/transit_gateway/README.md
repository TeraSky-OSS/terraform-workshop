# VPC and Transit Gateway Lab

This hands-on lab demonstrates how to create a VPC with public and private subnets and set up an AWS Transit Gateway using Terraform. The lab creates a complete network infrastructure including:
...
4. Transit Gateway for network connectivity
...
4. Deploy a Transit Gateway
5. Create Transit Gateway VPC attachment
6. Configure proper routing between subnets through the Transit Gateway
...
1. Navigate to this directory:
   ```bash
   cd hands_on_labs/aws/transit_gateway
   ```
...
- A Transit Gateway for network connectivity
...
- `transit_gateway_asn`: Private ASN for the Transit Gateway (default: 64512)
...
| <a name="input_vpc_name"></a> [vpc\_name](#input\_vpc\_name) | Name of VPC | `string` | `"terraform-workshop-vpc-lab"` | no |
